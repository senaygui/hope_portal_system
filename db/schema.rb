...
ActiveRecord::Schema[7.0].define(version: 2025_07_09_082026) do
  ...
  create_table "admin_users", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "gender"
    t.string "highest_level_educational_achievement"
  ...
  create_table "school_or_university_informations", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "tvet_program_attend"
    t.datetime "coc_attended_date"
    t.string "tvet_level"
