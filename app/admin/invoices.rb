ActiveAdmin.register Invoice, as: 'RegistrationPayment' do
  ...
  batch_action :approve_invoices do |ids|
    ...
    invoices.each do |invoice|
      ...
      invoice.payment_transaction.update(finance_approval_status: 'approved') if invoice.payment_transaction.present?
    end
  ...
  batch_action :deny_invoices do |ids|
    ...
    invoices.each do |invoice|
      ...
      invoice.payment_transaction.update(finance_approval_status: 'denied') if invoice.payment_transaction.present?
    end
